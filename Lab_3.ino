...
/**********************************/
//Tension resultante a reportar en la pantalla
float VCC = 0;
float VCC2 = 0;
float VCC3 = 0;
float VCC4 = 0;
...
//Formula para definir tension post-ADC
  ...
  VCC =  ((vcc1*5)/1023)*5;   //vcc1(24v)=994.356 ADC
  VCC2 = ((vcc2*7.5)/1023)*7.5;
  VCC3 = ((vcc3*11)/1023)*11;
  VCC4 = ((vcc4*11)/1023)*11;
